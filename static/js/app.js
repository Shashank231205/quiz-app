document.addEventListener('DOMContentLoaded', () => {
    ...
    const achievementNotes = [
        ...
        "Achievement Unlocked: Logic Master! Your reasoning is undeniable. [LOGO:/static/images/logo.png] 🤖",
        "Achievement Unlocked: Byte-Sized Brainiac! You pack a punch of intelligence. [LOGO:/static/images/logo.png]🧠",
        "Achievement Unlocked: Processor Prodigy! You think at lightning speed. [LOGO:/static/images/logo.png]💻",
        "Achievement Unlocked: Syntax Seeker! You find order in chaos. [LOGO:/static/images/logo.png] 📈",
        "Achievement Unlocked: Code Conjurer! You make magic with scripts. [LOGO:/static/images/logo.png]🧙",
        "Achievement Unlocked: Silicon Sorcerer! You command the very elements of computing. [LOGO:/static/images/logo.png]🔮",
        "Achievement Unlocked: Binary Bard! You tell tales in 0s and 1s. [LOGO:/static/images/logo.png]🎶",
        "Achievement Unlocked: Firewall Guardian! You stand strong against all challenges. [LOGO:/static/images/logo.png]🛡️",
        "Achievement Unlocked: Pixel Pioneer! You explore new digital frontiers. [LOGO:/static/images/logo.png] 🗺️",
        "Achievement Unlocked: Kernel King! You rule the core systems. [LOGO:/static/images/logo.png]👑",
        "Achievement Unlocked: Heuristic Hero! You're a master of smart shortcuts. [LOGO:/static/images/logo.png]🦸",
        "Achievement Unlocked: Cloud Commander! You have mastered the ether. [LOGO:/static/images/logo.png]☁️",
        "Achievement Unlocked: API Adept! You build bridges between worlds. [LOGO:/static/images/logo.png]🌉",
        "Achievement Unlocked: Matrix Maverick! You see the code in everything. [LOGO:/static/images/logo.png]🕶️",
        "Achievement Unlocked: Loop Legend! Your efficiency is legendary. [LOGO:/static/images/logo.png]🔄",
        "Achievement Unlocked: Cyber Crusader! A champion of the digital realm. [LOGO:/static/images/logo.png]⚔️",
        "Achievement Unlocked: Debug Duke! No bug can escape your watch. [LOGO:/static/images/logo.png]🐞",
        "Achievement Unlocked: Cache Captain! You have a memory like a vault. [LOGO:/static/images/logo.png] 💾",
        "Achievement Unlocked: Render Ranger! You bring ideas to life visually. [LOGO:/static/images/logo.png]🏞️",
        "Achievement Unlocked: Git Guru! You are a master of time and versions. [LOGO:/static/images/logo.png]📜",
        "Achievement Unlocked: JavaScript Juggernaut! An unstoppable force of the web. [LOGO:/static/images/logo.png]⚡",
        "Achievement Unlocked: Python Paladin! A holy warrior of versatile code. [LOGO:/static/images/logo.png]🐍",
        "Achievement Unlocked: Data Druid! You understand the secret language of data. [LOGO:/static/images/logo.png]🌳",
        "Achievement Unlocked: Boolean Baron! Your logic is either true or... true. [LOGO:/static/images/logo.png]🎩",
        "Achievement Unlocked: Stack Sentinel! You oversee the flow of information. [LOGO:/static/images/logo.png]🗼",
        "Achievement Unlocked: Thread Titan! You can handle multiple tasks at once. [LOGO:/static/images/logo.png]💪",
        "Achievement Unlocked: Vector Virtuoso! You excel in multidimensional spaces. [LOGO:/static/images/logo.png]🧭",
        "Achievement Unlocked: AI Artisan! You craft intelligence itself. [LOGO:/static/images/logo.png]🎨",
        "Achievement Unlocked: Machine Learning Mystic! You foresee patterns others can't. [LOGO:/static/images/logo.png] 🧿",
        "Achievement Unlocked: Deep Dreamer! Your imagination has layers. [LOGO:/static/images/logo.png]🌌",
        "Achievement Unlocked: Token Tactician! You know the value of every piece. [LOGO:/static/images/logo.png] ♟️",
        "Achievement Unlocked: Prompt Poet! You craft the perfect words for AI. [LOGO:/static/images/logo.png]✍️",
        "Achievement Unlocked: Variable Virtuoso! You master the art of change.[LOGO:/static/images/logo.png] 🎭",
        "Achievement Unlocked: Function Phantom! You appear exactly when needed. [LOGO:/static/images/logo.png]👻",
        "Achievement Unlocked: Compiler Captain! You translate thoughts into action. [LOGO:/static/images/logo.png]🚢",
        "Achievement Unlocked: Router Ruler! You direct the traffic of the internet. [LOGO:/static/images/logo.png]🚦",
        "Achievement Unlocked: Server Sage! A wise presence holding everything together. [LOGO:/static/images/logo.png]🧘",
        "Achievement Unlocked: Digital Demigod! Your power in this realm is immense. [LOGO:/static/images/logo.png]🔱",
        "Achievement Unlocked: Circuit Sage! You understand the flow of power. [LOGO:/static/images/logo.png]🔋",
        "Achievement Unlocked: Query Queen! You ask the right questions and get results. [LOGO:/static/images/logo.png]👸",
        "Achievement Unlocked: Bit Boss! You command the smallest of details. [LOGO:/static/images/logo.png]👨‍💼",
        "Achievement Unlocked: Cookie Connoisseur! You have excellent taste in data. [LOGO:/static/images/logo.png]🍪",
        "Achievement Unlocked: Interface Idol! Users love your style. [LOGO:/static/images/logo.png]🌟",
        "Achievement Unlocked: Protocol Prince! You set the rules of communication. [LOGO:/static/images/logo.png]🤴",
        "Achievement Unlocked: Script Scholar! Your knowledge of the craft is deep. [LOGO:/static/images/logo.png]🎓",
        "Achievement Unlocked: Runtime Royalty! You perform flawlessly under pressure. [LOGO:/static/images/logo.png]🏛️"
    ];
